...
interface ISceneFacade extends ISceneEvents {
    ...
    /**
     * 选择场景内所有节点，在不同模式下选不同的节点，比如light-probe-edit-mode开启的情况下，只选light-probe节点
     */
    selectAllNodes(): void;
     ...
     * @param uuid uuid
     */
    applyAnimationGraphVariant(uuid: string): void;
    ...
    /**
     * 查询一个 animation-graph-variant 的 dump 数据
     * @param uuid 资源的唯一标识符
     */
